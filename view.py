...
criarArquivos(
    "categoria.txt", "cliente.txt",
    "estoque.txt", "fornecedor.txt",
    "funcionario.txt", "venda.txt")
        ...
        if local == 1:
            ...
            while True:
                ...
                if decidir == 1:
                    ...
                    cat.cadastrarProduto(nome, preco, categoria, fornecedor, quantidade)
                elif decidir == 2:
                    ...
                    cat.alterarProduto(nomeAlterar, nome, preco, categoria, fornecedor, quantidade)
                elif decidir == 4:
                    cat.mostrarEstoque()
                else:
                    break
            ...
            while True:
                ...
                if decidir == 1:
                    ...
                    dataInicial = input("Digite a data de inicio no formato dia/mes/ano: \n")
                    dataFinal = input("Digite a data de termino no formato dia/mes/ano: \n")
